...
_DEPS = tree.h common.h diff_calc.h tree_output.h tex_consts.h tree_parsing.h tree_dsl.h file.h
DEPS = $(patsubst %,./%,$(_DEPS))

_OBJ = tree.o diff_calc.o main.o tree_output.o tree_parsing.o tree_dsl.o file.o
